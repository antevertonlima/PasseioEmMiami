            ...
            <nav class="top-bar">
                <div class="row medium-10 columns medium-offset-1">
                    ...
                    <dl class="sub-nav right subnav-lineheght">
                        ...
                        <dd class="active"><a href="./contato.php">Contato</a></dd>
                    </dl>
                </div>
            </nav>
            <div class="row shadow bg-white" style="padding:20px 0;">              
                <div class="area-total">
                    <div class="medium-4 columns">
						<img class="img-content" alt="Sobre-passeio-em-miami" src="assets/img/sobre-passeio-em-miami.png" />
					</div>
					<div class="medium-8 columns bg-contato bordas-radius">
