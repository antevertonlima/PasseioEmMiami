            ...
            <div class="row shadow bg-white">
                <ul class="example-orbit shadow" data-orbit>
                    <li> 
                        ...
                        <div class="orbit-caption"> Visão noturna de miami. </div> 
                    </li>
                    <li> 
                        <img alt="Visão noturna de miami." src="assets/img/miami-noite.jpg" />
                        <div class="orbit-caption"> Visão noturna de miami. </div> 
                    </li>
                    <li class="active"> 
                        <img alt="Belo predio a beira-mar." src="assets/img/mansao-beira-mar.jpg" />
                        <div class="orbit-caption"> Belo predio a beira-mar. </div> 
                    </li> 
                    <li> 
