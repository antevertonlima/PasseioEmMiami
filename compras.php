            ...
            <div class="row shadow bg-white" style="padding:20px 0;">              
                <div class="area-total">
                    <div class="medium-4 columns">
						<img  alt="Sobre-passeio-em-miami" src="assets/img/compras-passeio-em-miami.png" />
					</div>
					<div class="medium-8 columns bg-compras bordas-radius">
						...
						<a href="#" class="button expand secondary success radius">Entre em contato conosco.</a>
					</div>
