        ...
        <div class="fakeBody">
            <nav class="top-bar" data-topbar>
                <div class="row medium-10 columns medium-offset-1">
                    ...
                    <dl class="sub-nav right subnav-lineheight">
                        ...
                        <dd class="active"><a href="./compras.php">Compras</a></dd>
            ...
            <div class="row shadow painel">              
                <div class="area-total">
                    ...
                    <div class="small-12 medium-12 columns bg-compras bordas-radius">
                        ...
                        <ul class="clearing-thumbs small-block-grid-2 medium-block-grid-3" style="margin:10px 0;" data-clearing>
                            ...
                            while ($cont <= 15) {
                                ?>
                                <li>
                                    <a href="assets/uploads/compras/0<?php echo $cont; ?>.jpg">
                                        <img class="th radius" data-caption="Compras <?php echo $cont; ?>" src="assets/uploads/compras/0<?php echo $cont; ?>.jpg">
                                    </a>
                                </li>
                                <?php $cont++;
                            }
                        ...
                        <a href="#" class="button expand success radius">Entre em contato conosco.</a>
                    </div>
