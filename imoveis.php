        ...
        <div class="fakeBody">
            ...
            <div class="row shadow painel">              
                <div class="area-total">
                    ...
                    <div class="small-12 medium-12 columns bg-imoveis bordas-radius">
                        ...
                        <ul class="clearing-thumbs small-block-grid-2 medium-block-grid-3" style="margin:10px 0;" data-clearing>
                            ...
                            while ($cont <= 8) {
                                ?>
                                <li>
                                    <a href="assets/uploads/imoveis/0<?php echo $cont; ?>.jpg">
                                        <img class="th radius" data-caption="Imoveis <?php echo $cont; ?>" src="assets/uploads/imoveis/0<?php echo $cont; ?>.jpg">
                                    </a>
                                </li>
                                <?php $cont++;
                            }
